...
export function ExamChip({ exam, onSelect }: { exam: ExamDTO; onSelect: (exam: ExamDTO) => void }) {
  return (
    <button
      ...
      className="h-full w-full overflow-hidden rounded-lg border border-primary/30 bg-primary-soft px-2 py-1 text-left text-primary transition hover:brightness-95 cursor-pointer"
    >
